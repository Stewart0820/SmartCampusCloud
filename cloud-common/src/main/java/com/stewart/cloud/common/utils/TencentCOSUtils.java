...
public class TencentCOSUtils {
    // 此处填写的存储桶名称
    private static final String bucketName = "smart-1251531734";
    // secretId
    private static final String secretId = "AKIDjHXYGCOSllVx81v7Rmpc6JM7cqnT22i6";
    // secretKey
    private static final String secretKey = "C5iAJDrVv0qNdcMpHSMz1nHWUUCf5E7j";
